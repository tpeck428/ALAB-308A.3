...
function _getUserData() {
  _getUserData = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(id) {
    var dbName, _yield$Promise$all, _yield$Promise$all2, personalInfo, privateInfo, userData;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
        ...
        case 6:
          ...
          personalInfo = _yield$Promise$all2[0];
          privateInfo = _yield$Promise$all2[1];
